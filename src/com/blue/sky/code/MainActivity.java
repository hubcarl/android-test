...
import com.blue.sky.code.center.MyCollectionActivity;
import com.blue.sky.code.slidermenu.adapter.NavDrawerListAdapter;
import com.blue.sky.code.slidermenu.entity.NavDrawerItem;
import com.blue.sky.code.slidermenu.fragment.*;
...
public class MainActivity extends FragmentActivity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                Log.d(">>>Tab checkedId", checkedId+"");
                setTab(checkedId);
            }
        });

        setTab(R.id.tab_home);
        initView();
    ...
    private void setTab(int index)
    {
        ...
        android.app.Fragment fragment = FragmentFactory.getInstanceByIndex(index);
        if(fragment!=null){
    ...
    private void initView() {
        ...
        mNavDrawerItems.add(new NavDrawerItem(mNavMenuTitles[3], mNavMenuIconsTypeArray.getResourceId(3, -1), true, "22"));
        // Pages
        mNavDrawerItems.add(new NavDrawerItem(mNavMenuTitles[4], mNavMenuIconsTypeArray.getResourceId(4, -1)));
        // What's hot, We will add a counter here
        mNavDrawerItems.add(new NavDrawerItem(mNavMenuTitles[5], mNavMenuIconsTypeArray.getResourceId(5, -1), true, "50+"));
